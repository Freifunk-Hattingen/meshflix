[![Build Status](https://travis-ci.org/freifunk-en/meshflix.svg?branch=master)](https://travis-ci.org/freifunk-en/meshflix)

# meshflix
meshflix is a frontend for ffmap-backend based on a.l.f.r.e.d. data
...
![](http://map.ff-en.de/meshflix_1.jpg)
![](http://map.ff-en.de/meshflix_2.jpg)
...
`nodes.json` and `graph.json` (both are generated by ffmap-backend). Don't forget the
...
- `grafana` absolute or relative URL to grafana embed graph
...
To insert current node-id in either `href`, `grafana`, `thumbnail` or `caption`
...
Execute these commands on your server as a normal user to prepare the dependencies:
    ...
    git clone https://github.com/freifunk-en/meshflix.git
    cd meshflix
    npm install
...
Place your config.json in the `build/` directory. Now just copy `build/` into your servers document-home (e.g. /var/www/meshflix/ or /srv/http/meshflix/).
...
this is a fork of [ffnord/meshviewer](https://github.com/ffnord/meshviewer)
