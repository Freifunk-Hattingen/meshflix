  ...
  return function(nodes, field, router, title) {
    ...
    self.setData = function (data) {
      ...
      var items = list.map( function (d) {
        ...
        if (typeof d.nodeinfo.software !== "undefined") {
          if ((typeof d.nodeinfo.software.tunneldigger !== "undefined") && (d.nodeinfo.software.tunneldigger.enabled === true))
            td1Content.push(V.h("span", {className: "icon ion-earth"}))

          if ((typeof d.nodeinfo.software.fastd !== "undefined") && (d.nodeinfo.software.fastd.enabled === true))
            td1Content.push(V.h("span", {className: "icon ion-locked"}))
        }
