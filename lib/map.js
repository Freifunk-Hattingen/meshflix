define(["map/clientlayer", "map/labelslayer",
  ...
  function (ClientLayer, LabelsLayer, d3, L, moment, LocationMarker, rbush) {
    ...
    var iconOnline  = { color: "#1566A9", fillColor: "#3fa0d9", radius: 6, fillOpacity: 0.5, opacity: 0.5, weight: 2, className: "stroke-first" }
    var iconAlert   = { color: "#D43E2A", fillColor: "#e6a57f", radius: 4, fillOpacity: 0.5, opacity: 0.8, weight: 2, className: "stroke-first node-alert" }
    var iconLost    = { color: "#D43E2A", fillColor: "#e6a57f", radius: 4, fillOpacity: 0.5, opacity: 0.8, weight: 1, className: "stroke-first" }
    var iconOffline = { color: "#D43E2A", fillColor: "#e6a57f", radius: 3, fillOpacity: 0.3, opacity: 0.5, weight: 1, className: "stroke-first" }
      ...
      function updateView(nopanzoom) {
        ...
        if (highlight !== undefined)
          if (highlight.type === "node") {
            ...
            if (m)
              m.setStyle({ color: "violet", weight: 22, fillOpacity: 1, opacity: 0.5, className: "stroke-first" })
