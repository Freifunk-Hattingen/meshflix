define(["moment", "numeral", "tablesort", "tablesort.numeric"],
  ...
  function showCPUBar(className, v) {
    var span = document.createElement("span")
    span.classList.add("bar")
    span.classList.add(className)
  ...
  function showCPU(d) {
    ...
    return function (el) {
      el.appendChild(showCPUBar("cpu-usage", d.statistics.loadavg))
    }
  }
  ...
  function showStatImg(o, nodeId) {
    ...
    if (o.grafana) {
      ...
      content.src = o.grafana.replace("{NODE_ID}", nodeId)
    }
  ...
  return function(config, el, router, d) {
    ...
    attributeEntry(attributes, "System Auslastung", showCPU(d))
    attributeEntry(attributes, "RAM Auslastung", showRAM(d))
